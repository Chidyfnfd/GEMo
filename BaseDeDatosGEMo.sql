...
INSERT INTO usuarios (email, password, tipo_usuario, emociones, actividades) 
VALUES ('admin@gemo.com', '123', 0, JSON_ARRAY('Feliz','Neutral','Enojo'), JSON_ARRAY('Estudiar','Dormir','Pintar'));

-- Insertar Clientes (Pass: 123)
-- Asumimos ID=2 y ID=3
INSERT INTO usuarios (email, password, tipo_usuario, emociones, actividades) 
VALUES ('cliente1@mail.com', '123', 1, JSON_ARRAY('Miedo','Pensativo','Enojo'), JSON_ARRAY('Estudiar','Dormir','Cantar')),
       ('cliente2@mail.com', '123', 1, JSON_ARRAY('Miedo','Neutral','Enojo'), JSON_ARRAY('Estudiar','Dormir','Pintar'));
